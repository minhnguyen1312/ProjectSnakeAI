...
public class Config {
    ...
    static {
        try {
            root = new File(ScoreMain.class.getProtectionDomain().getCodeSource().getLocation()
                    .toURI()).getPath();
    ...
    public Path configPath = Paths.get(root + "/Game/gameSettings.txt");

    // Prey Type
    public static File APPLE_SKIN = new File(root + "/Game/skin/apple8bit.png");
    public static File CHERRY_SKIN = new File(root + "/Game/skin/cherry.png");
    public static File BANANA_SKIN = new File(root + "/Game/skin/banana.png");
    public static File MOUSE_SKIN = new File(root + "/Game/skin/mouse.png");
    public File SKIN;
    ...
    public void loadPreySkin() throws IOException {
        // default skin = apple
        SKIN = new File(root + "/Game/skin/apple8bit.png");
